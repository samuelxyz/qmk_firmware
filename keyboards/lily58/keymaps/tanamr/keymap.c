 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |GameFn|   A  |   S  |   D  |   F  |   G  |-------.    ,-------|   H  | Left |  Dn  |Right |   ;  | Bksp |
 * |------+------+------+------+------+------|   H   |    |  F2   |------+------+------+------+------+------|
 * |LCtrl |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |  -   |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LAlt | Shift|Space | / Enter /       \   I  \  |   J  |   K  |   L  |
 *                   |(RCtrl)      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
...
[_GAME] = LAYOUT(
  ...
  MO(_GAMEFN), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_LEFT, KC_DOWN, KC_RGHT, KC_SCLN, KC_BSPC,
  KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_H, KC_F2, KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_MINS,
  KC_RCTL, KC_LSFT, KC_SPC, KC_ENT, KC_I, KC_J, KC_K, KC_L
),
...
[_GAMEFN] = LAYOUT(
  ...
  KC_LCTL, KC_F11, KC_F12, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
